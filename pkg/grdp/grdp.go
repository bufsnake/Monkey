...
import (
	...
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/nla"
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/pdu"
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/rfb"
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/sec"
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/t125"
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/tpkt"
	"github.com/bufsnake/Monkey/pkg/grdp/protocol/x224"
	"log"
	"net"
	"os"
	"sync"
...
func (g *Client) loginForSSL(domain, user, pwd string) error {
	conn, err := net.DialTimeout("tcp", g.Host, 10*time.Second)
	if err != nil {
